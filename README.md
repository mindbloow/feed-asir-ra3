...
## Grupo Enrique,Pablo y Javi: *Noticias de actualidad en España*
...
<entry>
    ...
    <link rel="alternate" href="https://elpais.com/espana/2025-12-06/sanchez-sanidad-publica"/>
    <id>https://elpais.com/espana/2025-12-06/sanchez-sanidad-publica</id>
    <updated>2025-12-06T12:00:00Z</updated>
    <summary>El presidente del Gobierno destaca la importancia de la sanidad pública frente a las propuestas de privatización.</summary>
    <author>
      <name>EL PAÍS</name>
    </author>
</entry>
...
El archivo se validó correctamente en el validador de W3C. No hubo errores; Atom es más estricto que RSS, pero su estructura es clara.
...
Me encargué de coordinar que ambos feeds usaran las mismas noticias y que los enlaces y fechas fueran coherentes. Publiqué los archivos en **GitHub** para obtener una URL accesible en Raw y realicé las pruebas con el agregador **Feedly**.
...
- **captura1_validacion_rss.png** – Captura del feed RSS validado correctamente.
- **captura2_validacion_atom.png** – Captura del feed Atom validado correctamente.
- **captura1_agregador_rss.png** – Visualización del feed RSS en el agregador.
- **captura2_agregador_atom.png** – Visualización del feed Atom en el agregador.
...
ENLACE DEL REPOSTIORIO USADO EN GITHUB: https://github.com/mindbloow/feed-asir-ra3
